<?php
/* Smarty version 4.1.0, created on 2022-09-05 17:29:27
  from 'C:\xampp\htdocs\dev\ForumC2C\themes\default\subtemplates\posting.inc.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_631631f7768aa1_34262199',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '09d3fe4b4f62c45ab35c72bffbcd32582314ad10' => 
    array (
      0 => 'C:\\xampp\\htdocs\\dev\\ForumC2C\\themes\\default\\subtemplates\\posting.inc.tpl',
      1 => 1662397967,
      2 => 'file',
    ),
  ),
...
function content_631631f7768aa1_34262199 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->tpl_vars['settings']->value['tags'] > 0 && (($_smarty_tpl->tpl_vars['settings']->value['tags'] == 1 && ($_smarty_tpl->tpl_vars['admin']->value || $_smarty_tpl->tpl_vars['mod']->value)) || ($_smarty_tpl->tpl_vars['settings']->value['tags'] == 2 && ($_smarty_tpl->tpl_vars['user_type']->value === 0 || $_smarty_tpl->tpl_vars['admin']->value || $_smarty_tpl->tpl_vars['mod']->value)) || $_smarty_tpl->tpl_vars['settings']->value['tags'] > 2)) {?>
<p>
<label for="tags" class="input"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'tags_marking');?>
</label>
<input id="tags" type="text" size="50" name="tags" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['tags']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
...
$_smarty_tpl->tpl_vars['code_language']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['code_language']->value) {
$_smarty_tpl->tpl_vars['code_language']->do_else = false;
?>
...
$_smarty_tpl->tpl_vars['smiley']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['smiley']->value) {
$_smarty_tpl->tpl_vars['smiley']->do_else = false;
...
<ul>
 <li><input id="sticky_none" type="radio" name="sticky" value="0"<?php if (!$_smarty_tpl->tpl_vars['sticky']->value || ($_smarty_tpl->tpl_vars['sticky']->value && $_smarty_tpl->tpl_vars['sticky']->value == 0)) {?> checked="checked"<?php }?> />&nbsp;<label for="sticky_none"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'sticky_none');?>
</label></li>
<?php if ($_smarty_tpl->tpl_vars['categories']->value) {?>
 <li><input id="sticky_cat" type="radio" name="sticky" value="1"<?php if ($_smarty_tpl->tpl_vars['sticky']->value && $_smarty_tpl->tpl_vars['sticky']->value == 1) {?> checked="checked"<?php }?> />&nbsp;<label for="sticky_cat"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'sticky_single_cat');?>
</label></li>
 <li><input id="sticky_all" type="radio" name="sticky" value="2"<?php if ($_smarty_tpl->tpl_vars['sticky']->value && $_smarty_tpl->tpl_vars['sticky']->value == 2) {?> checked="checked"<?php }?> />&nbsp;<label for="sticky_all"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'sticky_all_cats');?>
</label></li>
<?php } else { ?>
 <li><input id="sticky_nocat" type="radio" name="sticky" value="1"<?php if ($_smarty_tpl->tpl_vars['sticky']->value && $_smarty_tpl->tpl_vars['sticky']->value == 1) {?> checked="checked"<?php }?> />&nbsp;<label for="sticky_nocat"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'sticky_thread');?>
</label></li>
<?php }?>
</ul>
<?php }?>
