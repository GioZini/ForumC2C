<?php
/* Smarty version 4.1.0, created on 2022-09-06 00:51:41
  from 'C:\xampp\htdocs\dev\ForumC2C\themes\default\subtemplates\contact.inc.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6316999d37d2b1_51443713',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '38e96c32a9daeabf6780b862e0b0d6f365306e3f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\dev\\ForumC2C\\themes\\default\\subtemplates\\contact.inc.tpl',
      1 => 1662397967,
      2 => 'file',
    ),
  ),
...
function content_6316999d37d2b1_51443713 (Smarty_Internal_Template $_smarty_tpl) {
...
" /><?php }
if ($_smarty_tpl->tpl_vars['recipient_user_id']->value) {?><input type="hidden" name="recipient_user_id" value="<?php echo $_smarty_tpl->tpl_vars['recipient_user_id']->value;?>
" /><?php }
...
" /><?php }
if (!$_smarty_tpl->tpl_vars['user_id']->value) {?><p><label for="sender_email"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'sender_address_caption');?>
</label><br />
<input id="sender_email" type="text" name="sender_email" value="" size="50" /></p><?php }?>
<p><label for="subject"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'subject_caption');?>
</label><br />
<input id="subject" type="text" name="subject" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['subject']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
...
<textarea id="message" name="text" rows="20" cols="80"><?php echo (($tmp = $_smarty_tpl->tpl_vars['text']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
</textarea></p>
<?php if ($_smarty_tpl->tpl_vars['captcha']->value) {
...
if ($_smarty_tpl->tpl_vars['user_id']->value) {?><p><input id="confirmation_email" type="checkbox" name="confirmation_email" value="1" />&nbsp;<label for="confirmation_email"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'sender_confirmation_caption');?>
</label></p><?php }?>
