<?php /* Smarty version 4.1.0, created on 2022-08-23 18:16:33
         compiled from 'C:\xampp\htdocs\giovanni\ForumC2C\lang\english.lang' */ ?>
<?php
/* Smarty version 4.1.0, created on 2022-08-23 18:16:33
  from 'C:\xampp\htdocs\giovanni\ForumC2C\lang\english.lang' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_63051981a381e6_62789968',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '62a67351d8e38ea1bb5bd9cee593511f57796a97' => 
    array (
      0 => 'C:\\xampp\\htdocs\\giovanni\\ForumC2C\\lang\\english.lang',
      1 => 1661278591,
      2 => 'file',
    ),
  ),
...
function content_63051981a381e6_62789968 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'forum_time' => 'Hora do Fórum: [time]',
        'forum_time_with_time_zone' => 'Hora do Fórum: [time] ([time_zone])',
    ...
    array (
      ...
      array (
        ...
        'next_page_link_title' => 'próxima página',
        'previous_page_link_title' => 'página anterior',
        'posted_by' => 'por <strong>[name]</strong>[email_hp]<span class="interpunction">, </span>[time]',
        'posted_by_location' => 'por <strong>[name]</strong>[email_hp]<span class="interpunction">, </span>[location]<span class="interpunction">, </span>[time]',
        'original_posting_linktitle' => 'clique para ir ao post original de [name]',
        'error_headline' => 'Erro!',
        'no_authorisation' => 'Sem Autorização!',
        'page_doesnt_exist' => 'Essa página não existe!',
        'error_form_uncomplete' => 'Preencha todos os campos!',
        'caution' => 'Cuidado!',
        'spam' => 'Spam',
        'forum_index_link' => 'Página inicial do fórum',
        'forum_index_link_title' => 'Página inicial do fórum',
        'log_in_link' => 'Entrar',
        'log_in_link_title' => 'Entrar',
        'log_out_link' => 'Desconectar',
        'log_out_link_title' => 'Desconectar',
        'register_link' => 'Se registrar',
        'register_link_title' => 'Se registrar como novo usuário',
        'profile_link_title' => 'Editar perfil',
        'user_area_link' => 'Usuários',
        'user_area_link_title' => 'Área do usuário',
        'admin_area_link' => 'Administrador',
        'admin_area_link_title' => 'Área do administrador',
        'search_marking' => 'Procurar:',
        'search_default_value' => 'Procurar...',
        'search_title' => 'Procurar mensagens',
        'new_topic_link' => 'Novo tópico',
        'new_topic_link_title' => 'Postar novo tópico',
        'back_to_top_link' => 'Para o topo',
        'back_to_top_link_title' => 'Voltar ao topo da página',
        'order_link' => 'Ordem',
        'order_link_title_1' => 'Ordem por data da última resposta',
        'order_link_title_2' => 'Ordem por data do fio (padrão)',
        'fold_threads' => 'Esconder fios',
        'fold_threads_linktitle' => 'Esconder respostas',
        'expand_threads' => 'Expandir fios',
        'expand_threads_linktitle' => 'Mostrar respostas',
        'table_view' => 'Ver tabela',
        'table_view_linktitle' => 'Mostrar mensagens em forma de tabela',
        'thread_view' => 'Ver fio',
        'thread_view_linktitle' => 'Mostrar mensagens em árvore de fios',
        'refresh_link' => 'Atualizar',
        'refresh_linktitle' => 'Reset new and read postings',
        'thread_hierarchical' => 'Hierárquica',
        'thread_hierarchical_linktitle' => 'Mostrar fio em ordem hierárquica (padrão)',
        'open_in_thread_link' => 'Abrir o fio',
        'open_in_thread_linktitle' => 'Mostrar essa publicação no fio completo',
        'thread_linear' => 'Linear',
        'thread_linear_linktitle' => 'Mostrar fio em ordem linear',
        'fold_posting_title' => 'Esconder/mostrar postagem',
        'fold_postings' => 'Esconder/mostrar',
        'fold_postings_title' => 'Esconder todas postagens',
        'expand_fold_thread_linktitle' => 'Mostrar / esconder fio',
        'category_title' => 'Categoria',
        'all_categories' => 'Todas categorias',
        'my_category_selection' => 'Minhas categorias',
        'browse_page_title' => 'Páginas',
        'thread_entry_back_link' => 'De volta à página inicial do fórum',
        'thread_entry_back_title' => 'Página inicial do fórum',
        'reply_link' => 'Publicar resposta',
        'reply_link_title' => 'Responder essa mensagem',
        'back_to_index_link' => 'De volta à página inicial do fórum',
        'back_to_index_link_title' => 'Página inicial do fórum',
        'back_to_entry_link' => 'Voltar à entry de [name]',
        'back_to_entry_link_title' => 'Voltar à entry de [name]',
        'subnav_login' => 'Login',
        'subnav_pw_forgotten' => 'Esqueceu a senha?',
        'subnav_accept_dps' => 'Aceitar os termos de privacidade',
        'subnav_accept_tou' => 'Aceitar os termos de usuário',
        'subnav_admin_area' => 'Área do administrador',
        'subnav_settings' => 'Configuração de fórum',
        'subnav_advanced_settings' => 'Configurações avançadas',
        'subnav_categories' => 'Categorias',
        'subnav_edit_category' => 'Editar categoria',
        'subnav_delete_category' => 'Excluir categoria',
        'subnav_user' => 'administração de usuário',
        'subnav_smilies' => 'Emoticons',
        'subnav_pages' => 'Páginas',
        'subnav_delete_page' => 'Excluir página',
        'subnav_edit_page' => 'Editar página',
        'subnav_add_page' => 'Adicionar página',
        'subnav_create_page' => 'Criar página',
        'subnav_edit_smiley' => 'Editar emoticon',
        'subnav_edit_user' => 'Editar usuário',
        'subnav_delete_users' => 'Excluir usuários',
        'subnav_delete_entries_user' => 'Excluir postagens de usuários',
        'subnav_register_user' => 'Registro de usuário',
        'subnav_spam_protection' => 'Proteção contra spam',
        'subnav_email_list' => 'Lista de e-mails de usuários registrados',
        'subnav_clear_userdata' => 'Limpar dados de usuários',
        'subnav_search' => 'Procurar',
        'subnav_list_spam' => 'Spam',
        'subnav_register' => 'Registrar',
        'subnav_reset_uninstall' => 'Resetar / desinstalar forum',
        'subnav_userarea' => 'Área de usuário',
        'subnav_contact' => 'Contato',
        'subnav_userarea_show_user' => '[var]',
        'subnav_userarea_show_posts' => 'Postagens po [var]',
        'subnav_userarea_edit_user' => 'Editar perfil',
        'subnav_userarea_edit_pw' => 'Mudar Senhas',
        'subnav_userarea_edit_mail' => 'Mudar endereço de e-mail',
        'subnav_userarea_remove_account' => 'Excluir conta',
        'subnav_backup' => 'Backup',
        'subnav_update' => 'Atualizar',
        'subnav_update_run' => 'Executar atualização',
        'subnav_delete_backup_file' => 'Excluir arquivo de backup',
        'subnav_restore' => 'Restaurar',
        'subnav_locked' => 'Conta bloqueada',
        'subnav_delete_cookie' => 'Excluir cookie',
        'subnav_disabled' => 'Forum desabilitado',
        ...
        'subnav_page' => '[var]',
        'counter' => '[total_postings] Postagens em [total_threads] Fios, [registered_users] usuários registrados',
        'counter_users_online' => '[total_postings] Postagens em [total_threads] Fios, [registered_users] usuários registrados, [total_users_online] usuários online ([registered_users_online] registrados, [unregistered_users_online] visitante)',
        ...
        'no_messages' => 'Nenhuma postagem foi feita até agora.',
        'no_messages_in_category' => 'Nenhuma postagem foi feita até agora nesta categoria.',
        ...
        'posting_minutes_ago' => '[minutes] minutos atrás',
        'posting_hours_ago' => '[hours] horas, [minutes] min. atrás',
        'posting_one_day_ago' => '1 dia, [hours] horas, [minutes] min. atrás',
        'posting_several_days_ago' => '[days] dias atrás',
    ...
    array (
      ...
      array (
        ...
        'tags_marking' => 'Tags:',
        'one_view' => '1 visualização',
        'several_views' => '[views] visualizações',
        'complete_thread_marking' => 'Fio completo:',
        'branch_marking' => 'Galho atual do fio:',
    ...
    array (
      ...
      array (
        ...
        'new_topic_hl' => 'Novo tópico',
        'reply_hl' => 'Postar resposta',
        'edit_hl' => 'Editar post',
        'name_marking' => 'Nome:',
        'email_marking' => 'E-mail:',
        'hp_marking' => 'Página:',
        'location_marking' => 'Local:',
        'optional' => '(opcional)',
        'optional_email' => '(opcional, não será mostrado diretamente)',
        'honeypot_field_marking' => 'Deixe esse campo vazio:',
        'remember_userdata_marking' => 'Lembrar de mim (cookie)',
        'delete_cookie_linkname' => 'excluir cookie',
        'category_marking' => 'Categoria:',
        'subject_marking' => 'Assunto:',
        'message_marking' => 'Mensagem:',
        'tags_marking' => 'Tags:',
        'tags_note' => '(opcional, separados por vírgula)',
        'bbcode_bold_label' => 'negrito',
        'bbcode_bold_title' => 'format text bold',
        'bbcode_bold_instruction' => '[b]bold text[/b]',
        'bbcode_italic_label' => 'itálico',
        'bbcode_italic_title' => 'format text italic',
        'bbcode_italic_instruction' => '[i]italic text[/i]',
        'bbcode_color_label' => 'cor',
        ...
        'message_submit_button' => 'OK - Enviar',
        'message_submit_title' => 'Save entry',
        'message_preview_button' => 'Prévia',
    ...
    array (
      ...
      array (
        ...
        'login_auto' => 'Conecte-me automaticamente neste computador',
        'login_submit' => 'Login',
        'login_advice' => 'Para logar, cookies serão utilizados!',
        'pw_forgotten_link' => 'Esqueci minha senha.',
    ...
    array (
      'vars' => 
      array (
        'register_exp' => 'Por favor, especifique o nome de usuário desejado, uma senha e um endereço de e-mail válido. Uma chave de ativação será enviada para este endereço de e-mail. A conta deve ser ativada dentro de um dia.',
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          2 => 'Unpack the script package',
          3 => 'Look for the according update file in the subfolder "update" and upload this file into the folder "update" on your server',
          4 => 'Look for the file "VERSION" in the subfolder "config" and upload this file into the folder "config" on your server',
          5 => 'Reload this page and the update file should appear below',
          6 => 'Click on the file and follow the further instructions',
          7 => 'After running the update you get a list of files and folders which have to be added or replaced',
          8 => 'Clear the directory <strong>templates_c</strong> (delete all files in this dirctory) after you have added/replaced the files/folders',
        ),
